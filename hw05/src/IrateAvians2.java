  ...
  *  Recitation: 209
  *
  *  Execution: java IrateAvians2 [filename]
  *
  *  Represents the Irate Avians game. Reads a text file
  *  and initializes a game arena with that data.
  *  Runs the game until the player wins or loses.
  *
  */


public class IrateAvians2 {
